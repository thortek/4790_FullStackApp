...
const css$1 = {
  code: "div.svelte-1w46syp{width:100%;height:100%}",
  map: null
};
const IntersectionObserver_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"svelte-1w46syp"}"${add_attribute("this", container, 0)}>${slots.default ? slots.default({ intersecting }) : ``}
</div>`;
});
const Image_svelte_svelte_type_style_lang = "";
const css = {
  code: "img.svelte-1fkx68q{height:200px;opacity:0;transition:opacity 1200ms ease-out}img.loaded.svelte-1fkx68q{opacity:1}",
  map: null
};
const Image = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.alt === void 0 && $$bindings.alt && alt !== void 0)
    $$bindings.alt(alt);
  $$result.css.add(css);
  return `<img${add_attribute("src", src, 0)}${add_attribute("alt", alt, 0)} loading="${"lazy"}" onerror="${"onerror = null; this.src='favicon.png';"}" class="${["svelte-1fkx68q", ""].join(" ").trim()}"${add_attribute("this", thisImage, 0)}>`;
});
